...
create_symlink_linux() { 
        ...
        do 
            link=$(basename "$f");
            ln -sfn $f $CONDA_PREFIX/bin/${link};
        done
        ...
        do 
            link=$(basename "$f");
            ln -sfn $f $CONDA_PREFIX/lib/${link};
        ...
        do 
            link=$(basename "$f");
            ln -sfn $f $CONDA_PREFIX/include/${link};

        done


        ln -sfn $CONDA_PREFIX/pkgs/cudatoolkit-dev/nvvm $CONDA_PREFIX/
